...
$lexfloatclient_version ="v4.16.1"
...
Copy-Item -Path ".\tmp\windows\LexFloatClient-Win\THIRD-PARTY-NOTICES.txt" -Destination ".\lib\bindings\windows\THIRD-PARTY-NOTICES.txt"
